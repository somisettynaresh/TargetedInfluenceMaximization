 ...
 */
public class MaxTargetInfluentialNodeWithRandomDAG3 extends MaxTargetInfluentialNode {
    final static Logger logger = Logger.getLogger(MaxTargetInfluentialNodeWithRandomDAG3.class);

    private static MaxTargetInfluentialNodeWithRandomDAG3 instance = null;
    ...
    private MaxTargetInfluentialNodeWithRandomDAG3() {

    }

    private MaxTargetInfluentialNodeWithRandomDAG3(DirectedGraph graph, Set<String> targetLabels, int noOfSimulations) {
    ...
    public static MaxTargetInfluentialNodeWithRandomDAG3 getInstance(DirectedGraph graph, Set<String> targetLabels, int noOfSimulations) {
        if (instance == null) {
            instance = new MaxTargetInfluentialNodeWithRandomDAG3(graph, targetLabels, noOfSimulations);
        }
        return instance;
    }
    ...
    public List<NodeWithInfluence> find(DirectedGraph graph, Set<Integer> nodes, Set<Integer> seedSet, Set<String> targetLabels, int noOfSimulations) {
        ...
        for (Map<Integer, Set<Integer>> dagReachableMap : reachableSetDagList) {
